...
import { Image, ImageStyle, Linking, SafeAreaView, View, ViewStyle } from "react-native"
import {
...
export function CustomDrawerContentComponent(props: DrawerContentComponentProps) {
  return (
    <DrawerContentScrollView
      {...mergeAll(flatten([{ contentContainerStyle: DRAWER_CONTAINER_STYLE }, props]))}
    >
      <View style={DRAWER_HEADER}>
        <Image source={drawerHeader} style={DRAWER_HEADER_IMAGE} resizeMode={"cover"} />
      </View>
        <SafeAreaView style={SAFE_AREA_VIEW_STYLE}>
          <DrawerItemList activeTintColor={color.palette.blue} itemStyle={DRAWER_ITEM} {...props} />
